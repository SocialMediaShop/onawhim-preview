          ...
          <div style={{
            ...
            <div className="acc-grid">
              ...
              <div style={{ padding: "40px 36px" }}>
                ...
                {pkg.departures.dates ? (
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 32 }}>
                    {pkg.departures.dates.map((d, i) => (
                      <Link 
                        key={i} 
                        href={`/enquire?pkg=${pkg.id}&date=${d}`}
                        style={{
                  ...
                  <div style={{ marginBottom: 32 }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 20 }}>
                      {pkg.departures.highSeason.map((d, i) => (
                        <Link 
                          key={i} 
                          href={`/enquire?pkg=${pkg.id}&date=${d} (High Season)`}
                          style={{
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                      {pkg.departures.shoulder.map((d, i) => (
                        <Link 
                          key={i} 
                          href={`/enquire?pkg=${pkg.id}&date=${d} (Shoulder Season)`}
                          style={{
                            fontFamily: "'Jost', sans-serif", fontSize: 12,
                ...
                {pkg.pagePath && (
                  <Link href={pkg.pagePath} className="cta-primary" style={{ width: "100%", textAlign: "center", marginBottom: 12 }}>
                    View Package Details →
                  </Link>
                )}
                <Link href={`/enquire?pkg=${pkg.id}`} className={pkg.pagePath ? "cta-ghost-light" : "cta-primary"} style={{ width: "100%", textAlign: "center", marginBottom: pkg.pdfPath ? 12 : 0 }}>
                  Enquire About This Package
                </Link>
                {pkg.pdfPath && (
                  <a href={pkg.pdfPath} target="_blank" rel="noopener noreferrer" className="cta-ghost-light" style={{ width: "100%", textAlign: "center", display: "block", marginTop: pkg.pagePath ? 12 : 0 }}>
...
export default function Safari({ isSafari = true }) {
  const safariSchema = {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(safariSchema) }}
      />
        ...
        <div className="sp" style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", padding: "0 56px" }}>
          <div>
            ...
            <div className="hi d4" style={{ display: "flex", gap: 14 }}>
              <Link href="/enquire" className="cta-primary">Start Planning</Link>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <Fade delay={0.2}>
            <div style={{
              ...
              <Link href="/enquire" className="cta-primary">Build My Itinerary →</Link>
            </div>
          </Fade>
        </div>
      </section>
          ...
          <Fade>
            <div style={{ maxWidth: 620 }}>
              ...
              <div style={{ display: "flex", gap: 14, flexWrap: "wrap", alignItems: "center" }}>
                <Link href="/enquire" className="cta-primary" style={{ background: t.gold }}>
                  Start Planning
                </Link>
